...
def analysis(clfs_names, result_dir, met_comp_dir):
    clfs_scores = {}
    clfs_mean_scores = {}
    met_mean_scores = {}

    for clf_name in clfs_names:
        clfs_scores[clf_name] = np.load(f'{result_dir}{clf_name}.npy')
        ...
        mean_score.to_csv(f'{result_dir}clfs_mean_scores/{clf_name}.csv', sep='\t')
    ...
    for i, metric_name in enumerate(metrics_names):
        ...
        mean_score.to_csv(f'{result_dir}metric_mean_scores/{met_comp_dir}{metric_name}.csv', sep='\t')
...
if __name__ == '__main__':
    ...
    analysis(clfs_names, result_dir, met_comp_dir)
