...
clfs = {
    # 'NBBAG_k7_fi0.5_eucl': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
    #                                                        n_estimators=N_ESTIMATORS,
    #                                                        k_neighbours=7,
    #                                                        fi=0.5,
    #                                                        random_state=RANDOM_STATE))]),
    # 'NBBAG_k7_fi1_eucl': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
    #                                                        n_estimators=N_ESTIMATORS,
    #                                                        k_neighbours=7,
    #                                                        fi=1,
    #                                                        random_state=RANDOM_STATE))]),
    'NBBAG_k7_fi1.5_cityblock': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
                                                                              n_estimators=N_ESTIMATORS,
                                                                              k_neighbours=7,
                                                                              fi=1.5,
                                                                              dist_metric="cityblock",
                                                                              random_state=RANDOM_STATE))]),
    'NBBAG_k7_fi1.5_cosine': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
                                                                           n_estimators=N_ESTIMATORS,
                                                                           k_neighbours=7,
                                                                           fi=1.5,
                                                                           dist_metric="cityblock",
                                                                           random_state=RANDOM_STATE))]),
    'NBBAG_k7_fi1.5_manhattan': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
                                                                           n_estimators=N_ESTIMATORS,
                                                                           k_neighbours=7,
                                                                           fi=1.5,
                                                                           dist_metric="manhattan",
                                                                           random_state=RANDOM_STATE))]),
    # 'NBBAG_k7_fi2_eucl': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
    #                                                        n_estimators=N_ESTIMATORS,
    #                                                        k_neighbours=7,
    #                                                        fi=2,
    #                                                        random_state=RANDOM_STATE))]),
    # 'NBBAG_k3_fi1_eucl': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
    #                                                        n_estimators=N_ESTIMATORS,
    #                                                        k_neighbours=3,
    #                                                        fi=1,
    #                                                        random_state=RANDOM_STATE))]),
    # 'NBBAG_k5_fi1_eucl': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
    #                                                        n_estimators=N_ESTIMATORS,
    #                                                        k_neighbours=5,
    #                                                        fi=1,
    #                                                        random_state=RANDOM_STATE))]),
    ...
    #                                                        fi=1,
    #                                                        random_state=RANDOM_STATE))]),
    # 'NBBAG_k9_fi1_eucl': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
    #                                                        n_estimators=N_ESTIMATORS,
    #                                                        k_neighbours=9,
    #                                                        fi=1,
    #                                                        random_state=RANDOM_STATE))]),
    # 'NBBAG_k11_fi1_eucl': Pipeline(steps=[('model', NBBaggingClassifier(base_estimator=BASE_CLF,
    #                                                        n_estimators=N_ESTIMATORS,
    #                                                        k_neighbours=11,
    #                                                        fi=1,
    #                                                        random_state=RANDOM_STATE))]),                                                           
